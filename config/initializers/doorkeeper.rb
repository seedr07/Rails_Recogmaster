Doorkeeper.configure do
  ...
  resource_owner_authenticator do |routes| 
      User.find_by_id(session[:user_credentials_id]) || redirect_to(login_url)
  end
  ...
  resource_owner_from_credentials do 
    ...
    if app
      ...
      user = user && user.valid_password?(params[:password]) ? user : false
      params[:client_secret] = app.secret  if user
      user
    end
  end
  ...
  optional_scopes :read, :write, :admin, :trusted
